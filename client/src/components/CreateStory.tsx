...
export default function CreateStory() {
  ...
  const submitStoryMutation = useMutation({
    ...
    onSuccess: (data) => {
      toast({
        title: "Story Created!",
        description:
          "Your story has been saved. Let's collect your contact information.",
      });
  ...
  return (
    <section
      id="create-story"
      className="py-20 bg-[#FF6B6B] bg-opacity-5 relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl max-w-2xl mx-auto text-gray-600">
            Begin your journey to create a cherished keepsake for your family
          </p>
        </div>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-[#2D3436] font-bold font-['Quicksand']">
                      Story Title
                    </FormLabel>
                    <FormControl>
                      <Input
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <p className="text-sm text-gray-500 mt-2">
                      Write your story in simple sentences. Our illustrators
              ...
              <div>
                <label className="block text-[#2D3436] font-bold mb-2 font-['Quicksand']">
                ...
                <p className="text-sm text-gray-500 mt-2">
                  Photos will be used to personalize character appearances in
                  your story.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 mt-3">
                  Free preview shows your first 2 pages. No payment required.
