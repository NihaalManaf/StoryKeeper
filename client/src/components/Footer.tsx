...
import { Facebook, Instagram, Twitter, Share2, Mail, Phone, MapPin } from "lucide-react";
    ...
    <footer className="bg-[#2D3436] text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {/* Company Info */}
          <div>
            <h3 className="text-2xl font-bold font-['Quicksand'] mb-6">StoryKeeper</h3>
            <p className="text-gray-400 mb-6">Transforming your family stories into beautifully illustrated children's books that preserve your memories for generations.</p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xl font-bold font-['Quicksand'] mb-6">Quick Links</h3>
            <ul className="space-y-3">
              <li><a href="#how-it-works" className="text-gray-400 hover:text-white transition duration-300">How It Works</a></li>
              <li><a href="#examples" className="text-gray-400 hover:text-white transition duration-300">Example Stories</a></li>
              ...
              <li><a href="#blog" className="text-gray-400 hover:text-white transition duration-300">Our Blog</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#refunds" className="text-gray-400 hover:text-white transition duration-300">Refund Policy</a></li>
            </ul>
          </div>
          
          {/* Contact */}
          <div>
            <h3 className="text-xl font-bold font-['Quicksand'] mb-6">Contact Us</h3>
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-start">
                <Mail className="h-5 w-5 mt-1 mr-3" />
                <span>support@storykeeper.com</span>
              </li>
              <li className="flex items-start">
